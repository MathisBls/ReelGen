        ...
        <div className="relative flex flex-1 items-center">
          <div className="relative w-full">
            ...
            <input
              ...
              className="block h-10 w-full rounded-md border-0 py-1.5 pl-10 pr-3 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-purple-600 dark:bg-gray-700 dark:border-gray-600 sm:text-sm sm:leading-6"
              placeholder="Rechercher des médias, clips, templates..."
            />
          </div>
        </div>
